...
import 'package:coffee/features/cart/widgets/cart_items.dart';
import 'package:coffee/features/cart/widgets/cart_subtotal.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double sum = 0;
    user.cart
        .map((e) => sum += e['quantity'] * e['item']['price'])
        .toList();
    return Scaffold(
